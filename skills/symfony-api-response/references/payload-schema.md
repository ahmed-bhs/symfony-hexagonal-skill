...
use App\User\Application\UseCase\Command\UpdateUserProfile\UpdateUserProfileCommand;
use App\User\Application\UseCase\Query\GetUserById\GetUserByIdQuery;
use App\User\Application\UseCase\Query\ListUsers\ListUsersQuery;
...
final class UserController
{
    ...
    {
        $result = $this->queryBus->dispatch(new GetUserByIdQuery($id));
