...
### Port
```php
namespace App\Payment\Domain\Port\Out;
...
### Adapter
```php
namespace App\Payment\Infrastructure\Adapter\Out\Payment;

use App\Payment\Domain\Port\Out\PaymentGatewayInterface;
use App\Payment\Domain\Port\Out\PaymentResult;
use App\Payment\Domain\Port\Out\RefundResult;
use App\Shared\Domain\ValueObject\Money;
...
### Port
```php
namespace App\Notification\Domain\Port\Out;
...
### Adapter
```php
namespace App\Notification\Infrastructure\Adapter\Out\Storage;
...
### Port
```php
namespace App\Document\Domain\Port\Out;
...
### Adapter
```php
namespace App\Document\Infrastructure\Adapter\Out\Storage;

use App\Document\Domain\Port\Out\FileStorageInterface;
use Aws\S3\S3Client;
