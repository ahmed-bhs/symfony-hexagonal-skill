...
## Layer 1: Driving Adapter — Input Validation

### Request DTO Pattern

```php
namespace App\User\Infrastructure\Adapter\In\ApiPlatform\RegisterUser\Request;
...
public function create(Request $request, ValidatorInterface $validator): JsonResponse
{
    ...
    $command = new RegisterUserCommand($requestDto->email, $requestDto->name, $requestDto->password);
...
```php
namespace App\Shared\Infrastructure\Adapter\In\Validation;
